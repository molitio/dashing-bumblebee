    ...
    factory: function (require) {
        var plugin = (() => {
            ...
            var He = q((zn, rt) => {
                ...
                rt.exports = (e, r = {}) => {
                    let t = (n, s = {}) => {
                        let i = r.escapeInvalid && tt.isInvalidBrace(s), a = n.invalid === !0 && r.escapeInvalid === !0,
                            c = "";
                ...
                var Or = W("util"), At = ht(), dt = e => e !== null && typeof e == "object" && !Array.isArray(e),
                    ...
                    Br = (e, r, t) => {
                        ...
                        let _ = {negatives: [], positives: []},
                            y = T => _[T < 0 ? "negatives" : "positives"].push(Math.abs(T)), E = [], S = 0;
                        ...
                        let s = n.transform || (f => String.fromCharCode(f)), i = `${e}`.charCodeAt(0),
                            a = `${r}`.charCodeAt(0), c = i > a, p = Math.min(i, a), m = Math.max(i, a);
            ...
            var Ct = q((ts, xt) => {
                ...
                var Gr = Ue(), bt = ve(), qr = (e, r = {}) => {
                    let t = (n, s = {}) => {
                        let i = bt.isInvalidBrace(s), a = n.invalid === !0 && r.escapeInvalid === !0,
                            c = i === !0 || a === !0, p = r.escapeInvalid === !0 ? "\\" : "", m = "";
...
`,
            ...
            var Nt = q((ss, Ot) => {
                ...
                var jr = He(), {
                    ...
                    let s = {type: "root", input: e, nodes: []}, i = [s], a = s, c = s, p = 0, m = e.length, h = 0,
                        R = 0, f, $ = {}, _ = () => e[h++], y = E => {
            ...
            var me = q((is, qt) => {
                "use strict";
                var un = W("path"), se = "\\\\/", Mt = `[^${se}]`, ie = "\\.", cn = "\\+", ln = "\\?", Te = "\\/",
                    fn = "(?=.)", Dt = "[^/]", qe = `(?:${Te}|$)`, Ut = `(?:^|${Te})`, Ke = `${ie}{1,2}${qe}`,
                    pn = `(?!${ie})`, hn = `(?!${Ut}${Ke})`, dn = `(?!${ie}{0,1}${qe})`, gn = `(?!${Ke})`,
                    An = `[^.${Te}]`, mn = `${Dt}*?`, Gt = {
                        DOT_LITERAL: ie,
                        PLUS_LITERAL: cn,
                        QMARK_LITERAL: ln,
            ...
            var Yt = q((us, Zt) => {
                ...
                var Kt = Re(), {
                    ...
                    let t = r || {}, n = e.length - 1, s = t.parts === !0 || t.scanToEnd === !0, i = [], a = [], c = [],
                        p = e, m = -1, h = 0, R = 0, f = !1, $ = !1, _ = !1, y = !1, E = !1, S = !1, T = !1, L = !1,
                        z = !1, I = !1, re = 0, K, g, v = {value: "", depth: 0, isGlob: !1}, k = () => m >= n,
                        l = () => p.charCodeAt(m + 1), H = () => (K = g, p.charCodeAt(++m));
                    for (; m < n;) {
                        g = H();
                        let P;
                        if (g === ye) {
            ...
            var er = q((cs, Jt) => {
                ...
                var ke = me(), Y = Re(), {
                    ...
                    let H = [], w = [], B = [], o = i, u, P = () => l.index === s - 1,
                        b = l.peek = (A = 1) => e[l.index + A], V = l.advance = () => e[++l.index] || "",
                        J = () => e.slice(l.index + 1), X = (A = "", O = 0) => {
                    ...
                    for (; !P();) {
                        ...
                        if (l.brackets > 0 && (u !== "]" || o.value === "[" || o.value === "[^")) {
                            if (t.posix !== !1 && u === ":") {
                                ...
                                if (d.includes("[") && (o.posix = !0, d.includes(":"))) {
                                    let x = o.value.lastIndexOf("["), M = o.value.slice(0, x), j = o.value.slice(x + 2),
                                        G = On[j];
                                    if (G) {
                        ...
                        if (u === ",") {
                            ...
                            x && B[B.length - 1] === "braces" && (x.comma = !0, d = "|"), C({
                                type: "comma",
                                value: u,
                                output: d
                            });
            ...
            var rr = q((ls, tr) => {
                ...
                var Pn = W("path"), Mn = Yt(), Ze = er(), Ye = Re(), Dn = me(),
                    Un = e => e && typeof e == "object" && !Array.isArray(e), D = (e, r, t = !1) => {
                        ...
                        let s = r || {}, i = Ye.isWindows(r), a = n ? D.compileRe(e, r) : D.makeRe(e, r, !1, !0),
                            c = a.state;
                        delete a.state;
                        let p = () => !1;
                        if (s.ignore) {
                ...
                D.compileRe = (e, r, t = !1, n = !1) => {
                    ...
                    let s = r || {}, i = s.contains ? "" : "^", a = s.contains ? "" : "$",
                        c = `${i}(?:${e.output})${a}`;
                    e && e.negated === !0 && (c = `^(?!${c}).*$`);
                    let p = D.toRegex(c, r);
            ...
            var cr = q((ps, ur) => {
                "use strict";
                var ir = W("util"), or = Pt(), ae = sr(), ze = Re(), ar = e => e === "" || e === "./",
                    N = (e, r, t) => {
                        ...
                        for (let h = 0; h < r.length; h++) {
                            let R = ae(String(r[h]), {...t, onResult: c}, !0),
                                f = R.state.negated || R.state.negatedExtglob;
                            f && a++;
                            for (let $ of e) {
                                let _ = R($, !0);
                ...
                N.capture = (e, r, t) => {
                    let n = ze.isWindows(t),
                        i = ae.makeRe(String(e), {...t, capture: !0}).exec(n ? ze.toPosixSlashes(r) : r);
                ...
                pe = class extends Ne.BaseCommand {
                    ...
                    async execute() {
                        ...
                        let _ = this.parallel ? this.jobs === "unlimited" ? 1 / 0 : Number(this.jobs) || Math.ceil(F.nodeUtils.availableParallelism() / 2) : 1,
                            y = _ === 1 ? !1 : this.parallel, E = y ? this.interlaced : !0, S = (0, Ar.default)(_),
                            T = new Map, L = new Set, z = 0, I = null, re = !1, K = await _e.StreamReport.start({
                                configuration: t,
                                stdout: this.context.stdout,
                                includePrefix: !1
                            }, async g => {
                                let v = async (k, {commandIndex: l}) => {
                                    ...
                                    let H = qn(k, {
                                        ...
                                        commandIndex: l
                                    }), [w, B] = dr(g, {prefix: H, interlaced: E}), [o, u] = dr(g, {
                                        prefix: H,
                                        interlaced: E
                                    });
                                    try {
                                        this.verbose && g.reportInfo(null, `${H} Process started`);
                                        let P = Date.now(), b = await this.cli.run([this.commandName, ...this.args], {
                                            cwd: k.cwd,
                                            stdout: w,
                                            stderr: o
                                        }) || 0;
